...
public class NutritionFactController {
    ...
    public ResponseEntity<Slice<String>> getNutritionFact(@AuthenticationPrincipal AuthUser user, Pageable pageable, @RequestParam String foodName) {
        Slice<String> response = nutritionFactService.findByFoodName(foodName,pageable);
